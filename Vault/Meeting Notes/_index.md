...
תיעוד החלטות, מבנה, ותשתית של פרויקט the-five-agent. כל קובץ-טופיק מתאר רכיב/דמות אחת בפרויקט.
...
- [[gitignore]] — `.gitignore` (קבצים מוסתרים מ-Git)
- [[project-infrastructure]] — מבנה `.claude/` ושורש הפרויקט

### סקילים מקומיים (פרויקטיאליים)
